# ==========================================================
# COMPANY ENTERPRISE MAINTENANCE DEPLOYMENT – v7 FINAL
# ==========================================================
...
All company computers will perform scheduled maintenance and reboot tonight at 10:00 PM.

Please save your work before leaving and leave your computer powered ON.
...
# ==========================================================
# DAILY 6AM CHROME CACHE PURGE (PASSWORD SAFE)
# ==========================================================
...
# ==========================================================
# EVENT LOG CLEANUP (WEEKLY SUNDAY 4AM)
# ==========================================================
...
Register-CompanyTask "Company Saturday Maintenance Warning" "$scriptRoot\Saturday-Warning.ps1" `
(New-ScheduledTaskTrigger -Weekly -DaysOfWeek Saturday -At 4:00PM)

Register-CompanyTask "Company Weekly Cleanup" "$scriptRoot\Weekly-Cleanup.ps1" `
...
Register-CompanyTask "Company Daily Chrome Cache Purge" "$scriptRoot\Daily-ChromePurge.ps1" `
(New-ScheduledTaskTrigger -Daily -At 6:00AM)

Register-CompanyTask "Company Weekly Update Scan" "$scriptRoot\Weekly-Cleanup.ps1" `
(New-ScheduledTaskTrigger -Weekly -DaysOfWeek Sunday -At 1:00AM)

Register-CompanyTask "Company Weekly Defender Scan" "$scriptRoot\Weekly-Cleanup.ps1" `
(New-ScheduledTaskTrigger -Weekly -DaysOfWeek Sunday -At 2:00AM)

Register-CompanyTask "Company Weekly Disk Optimize" "$scriptRoot\Weekly-Cleanup.ps1" `
(New-ScheduledTaskTrigger -Weekly -DaysOfWeek Sunday -At 3:00AM)

Register-CompanyTask "Company Weekly EventLog Cleanup" "$scriptRoot\EventLog-Cleanup.ps1" `
(New-ScheduledTaskTrigger -Weekly -DaysOfWeek Sunday -At 4:00AM)

Register-CompanyTask "Company Startup Uptime Logger" "$scriptRoot\Startup-Uptime.ps1" `
